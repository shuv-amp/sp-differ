...
See `./FORMAT_V2.md` for the current v2 case format that extends the case model for official-vector send/receive coverage.
...
| status | u8 | Error code mapped from `./ERRORS.md`. |
