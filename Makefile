...
$(RUNNER_BIN): $(BUILD_VERSION_STAMP) $(RUNNER_SRC) $(WORKER_API_SRC) $(SEMANTIC_BRIDGE_SRC) $(CORE_SRC) $(CASE_SRC) $(VALIDATE_SRC)
	@mkdir -p $(BUILD_DIR)
	$(CXX) $(CXXFLAGS) $(BUILD_DEFINES) $(THREAD_FLAGS) $(SECP256K1_CFLAGS) $(OPENSSL_CFLAGS) -o $@ $(RUNNER_SRC) $(WORKER_API_SRC) $(SEMANTIC_BRIDGE_SRC) $(CORE_SRC) $(CASE_SRC) $(VALIDATE_SRC) $(DL_FLAGS) $(THREAD_FLAGS) $(SECP256K1_LIBS) $(OPENSSL_LIBS)

compare: $(COMPARE_BIN)

$(COMPARE_BIN): $(BUILD_VERSION_STAMP) $(COMPARE_SRC) $(WORKER_API_SRC) $(SEMANTIC_BRIDGE_SRC) $(CORE_SRC) $(CASE_SRC) $(VALIDATE_SRC)
	@mkdir -p $(BUILD_DIR)
	$(CXX) $(CXXFLAGS) $(BUILD_DEFINES) $(THREAD_FLAGS) $(SECP256K1_CFLAGS) $(OPENSSL_CFLAGS) -o $@ $(COMPARE_SRC) $(WORKER_API_SRC) $(SEMANTIC_BRIDGE_SRC) $(CORE_SRC) $(CASE_SRC) $(VALIDATE_SRC) $(DL_FLAGS) $(THREAD_FLAGS) $(SECP256K1_LIBS) $(OPENSSL_LIBS)

cli: $(CLI_BIN)

$(CLI_BIN): $(BUILD_VERSION_STAMP) $(CLI_SRC) $(REPORTER_SRC) $(WORKER_API_SRC) $(SEMANTIC_BRIDGE_SRC) $(CORE_SRC) $(CASE_SRC) $(VALIDATE_SRC)
	@mkdir -p $(BUILD_DIR)
	$(CXX) $(CXXFLAGS) $(BUILD_DEFINES) $(THREAD_FLAGS) $(SECP256K1_CFLAGS) $(OPENSSL_CFLAGS) -o $@ $(CLI_SRC) $(REPORTER_SRC) $(WORKER_API_SRC) $(SEMANTIC_BRIDGE_SRC) $(CORE_SRC) $(CASE_SRC) $(VALIDATE_SRC) $(DL_FLAGS) $(THREAD_FLAGS) $(SECP256K1_LIBS) $(OPENSSL_LIBS)
...
$(FUZZ_DRIVER_BIN): $(BUILD_VERSION_STAMP) $(FUZZ_DRIVER_SRC) $(FUZZ_HARNESS_OBJ) $(SEMANTIC_BRIDGE_SRC) $(WORKER_API_SRC) $(CORE_SRC) $(CASE_SRC) $(VALIDATE_SRC)
	@mkdir -p $(BUILD_DIR)
	$(CXX) $(CXXFLAGS) $(BUILD_DEFINES) $(THREAD_FLAGS) -fsanitize=address $(SECP256K1_CFLAGS) $(OPENSSL_CFLAGS) -o $@ $(FUZZ_DRIVER_SRC) $(FUZZ_HARNESS_OBJ) $(SEMANTIC_BRIDGE_SRC) $(WORKER_API_SRC) $(CORE_SRC) $(CASE_SRC) $(VALIDATE_SRC) $(DL_FLAGS) $(THREAD_FLAGS) $(SECP256K1_LIBS) $(OPENSSL_LIBS)
...
$(RELEASE_RUNNER_BIN): $(RELEASE_VERSION_STAMP) $(RUNNER_SRC) $(WORKER_API_SRC) $(SEMANTIC_BRIDGE_SRC) $(CORE_SRC) $(CASE_SRC) $(VALIDATE_SRC)
	@mkdir -p $(RELEASE_BUILD_DIR)
	$(CXX) $(RELEASE_CXXFLAGS) $(BUILD_DEFINES) $(THREAD_FLAGS) $(SECP256K1_CFLAGS) $(OPENSSL_CFLAGS) -o $@ $(RUNNER_SRC) $(WORKER_API_SRC) $(SEMANTIC_BRIDGE_SRC) $(CORE_SRC) $(CASE_SRC) $(VALIDATE_SRC) $(DL_FLAGS) $(THREAD_FLAGS) $(SECP256K1_LIBS) $(OPENSSL_LIBS)
	-$(RELEASE_STRIP) -S $@ 2>/dev/null || $(RELEASE_STRIP) $@

$(RELEASE_COMPARE_BIN): $(RELEASE_VERSION_STAMP) $(COMPARE_SRC) $(WORKER_API_SRC) $(SEMANTIC_BRIDGE_SRC) $(CORE_SRC) $(CASE_SRC) $(VALIDATE_SRC)
	@mkdir -p $(RELEASE_BUILD_DIR)
	$(CXX) $(RELEASE_CXXFLAGS) $(BUILD_DEFINES) $(THREAD_FLAGS) $(SECP256K1_CFLAGS) $(OPENSSL_CFLAGS) -o $@ $(COMPARE_SRC) $(WORKER_API_SRC) $(SEMANTIC_BRIDGE_SRC) $(CORE_SRC) $(CASE_SRC) $(VALIDATE_SRC) $(DL_FLAGS) $(THREAD_FLAGS) $(SECP256K1_LIBS) $(OPENSSL_LIBS)
	-$(RELEASE_STRIP) -S $@ 2>/dev/null || $(RELEASE_STRIP) $@

$(RELEASE_CLI_BIN): $(RELEASE_VERSION_STAMP) $(CLI_SRC) $(REPORTER_SRC) $(WORKER_API_SRC) $(SEMANTIC_BRIDGE_SRC) $(CORE_SRC) $(CASE_SRC) $(VALIDATE_SRC)
	@mkdir -p $(RELEASE_BUILD_DIR)
	$(CXX) $(RELEASE_CXXFLAGS) $(BUILD_DEFINES) $(THREAD_FLAGS) $(SECP256K1_CFLAGS) $(OPENSSL_CFLAGS) -o $@ $(CLI_SRC) $(REPORTER_SRC) $(WORKER_API_SRC) $(SEMANTIC_BRIDGE_SRC) $(CORE_SRC) $(CASE_SRC) $(VALIDATE_SRC) $(DL_FLAGS) $(THREAD_FLAGS) $(SECP256K1_LIBS) $(OPENSSL_LIBS)
	-$(RELEASE_STRIP) -S $@ 2>/dev/null || $(RELEASE_STRIP) $@
...
$(SANITIZE_RUNNER_BIN): $(RUNNER_SRC) $(WORKER_API_SRC) $(SEMANTIC_BRIDGE_SRC) $(CORE_SRC) $(CASE_SRC) $(VALIDATE_SRC)
	@mkdir -p $(SANITIZE_BUILD_DIR)
	$(SANITIZE_CXX) $(SANITIZE_CXXFLAGS) $(BUILD_DEFINES) $(THREAD_FLAGS) $(SECP256K1_CFLAGS) $(OPENSSL_CFLAGS) -o $@ $(RUNNER_SRC) $(WORKER_API_SRC) $(SEMANTIC_BRIDGE_SRC) $(CORE_SRC) $(CASE_SRC) $(VALIDATE_SRC) $(DL_FLAGS) $(THREAD_FLAGS) $(SECP256K1_LIBS) $(OPENSSL_LIBS)

$(SANITIZE_COMPARE_BIN): $(COMPARE_SRC) $(WORKER_API_SRC) $(SEMANTIC_BRIDGE_SRC) $(CORE_SRC) $(CASE_SRC) $(VALIDATE_SRC)
	@mkdir -p $(SANITIZE_BUILD_DIR)
	$(SANITIZE_CXX) $(SANITIZE_CXXFLAGS) $(BUILD_DEFINES) $(THREAD_FLAGS) $(SECP256K1_CFLAGS) $(OPENSSL_CFLAGS) -o $@ $(COMPARE_SRC) $(WORKER_API_SRC) $(SEMANTIC_BRIDGE_SRC) $(CORE_SRC) $(CASE_SRC) $(VALIDATE_SRC) $(DL_FLAGS) $(THREAD_FLAGS) $(SECP256K1_LIBS) $(OPENSSL_LIBS)
